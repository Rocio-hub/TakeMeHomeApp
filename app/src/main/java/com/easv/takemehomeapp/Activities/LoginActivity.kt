...
class LoginActivity : AppCompatActivity() {
    ...
    private fun insertTestData() {
        ...
        usersDB.emptyDb()
        usersDB.insertLostUser(BELostUser(1, "Peter", "Parker", "1 2 3", "email", "address", 123, "medication", "allergies", "diseases", "picture"))
        usersDB.insertLostUser(BELostUser(2, "Scarlet", "Witch", " 4 5 6", "email", "address", 456, "medication", "allergies", "diseases", "picture"))
        usersDB.insertLostUser(BELostUser(3, "Captain", "America", "7 8 9", "email", "address", 789, "medication", "allergies", "diseases", "picture"))
